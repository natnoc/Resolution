...
{
       0,    40,    40,    45,    46,    62,    63,    65,    85,    90,
      95,    99,   104,   108,   113,   117,   122,   126,   130,   135
};
#endif
...
static const char *const yytname[] =
{
  ...
  "left", "conj", "atom", "terms", "term", YY_NULLPTR
};
#endif
...
#line 46 "parser.y" /* yacc.c:1646  */
    {
		...
		if((yyvsp[-2].claus)->bd->isZielClause) {
			clause_list* cl_new = toClauseList((yyvsp[-2].claus), ziel_claus_list);
			ziel_claus_list = cl_new;
		} else {
			clause_list* cl_new = toClauseList((yyvsp[-2].claus), regel_claus_list);
...
#line 65 "parser.y" /* yacc.c:1646  */
    {
		...
		if((yyvsp[-2].bd) == NULL) {
			...
			if ((yyvsp[0].bd) == NULL) {
				(yyval.bd)->isZielClause = TRUE;
			//Wenn beide Seiten Formeln enthalten
			} else {
				//$<bd>3->next = $<bd>1;
				(yyval.bd) = (yyvsp[0].bd)->next;
			}
		}
		}
...
#line 85 "parser.y" /* yacc.c:1646  */
    {
			(yyval.bd) = tobody((yyvsp[0].atm), NULL);
			printf("\nRechts:\t");
			print_body((yyval.bd));
		}
...
#line 95 "parser.y" /* yacc.c:1646  */
    {
			printf("\nLinks:\t");
			(yyval.claus) = toclause((yyvsp[0].bd));
...
#line 108 "parser.y" /* yacc.c:1646  */
    {
			(yyval.bd) = tobody((yyvsp[-2].atm), (yyvsp[0].bd));
			//print_body($<bd>$);
		}
...
#line 113 "parser.y" /* yacc.c:1646  */
    {
			(yyval.atm) = toAtom((yyvsp[0].name), NULL);
			//print_atom($<atm>$);
		}
...
#line 117 "parser.y" /* yacc.c:1646  */
    {
			(yyval.atm) = toAtom((yyvsp[-3].name), (yyvsp[-1].termLst));
			//print_atom($<atm>$);
		}
...
#line 122 "parser.y" /* yacc.c:1646  */
    {
		(yyval.termLst) = toTermList((yyvsp[0].trm), NULL);
...
#line 126 "parser.y" /* yacc.c:1646  */
    {
		(yyval.termLst)=toTermList((yyvsp[-2].trm), (yyvsp[0].termLst));
		}
...
#line 130 "parser.y" /* yacc.c:1646  */
    {
			//printf("\nConstant:\t%s\n", $<name>1);
			(yyval.trm)=toTerm((yyvsp[0].name), NULL);
			//print_term($<trm>$);
		}
...
#line 135 "parser.y" /* yacc.c:1646  */
    {
			//printf("\nFunction:\t%s\n", $<name>1);
			(yyval.trm)=toTerm((yyvsp[-3].name), (yyvsp[-1].termLst));
			//print_term($<trm>$);
		}
